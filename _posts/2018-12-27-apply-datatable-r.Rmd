...
Based on this [study][1] and my observations, i find data manipulation using data.table in R faster than python pandas. I have not compared the `datatable` of pandas though. Regardless of the debate, here is what i have put together tutorial on using it with apply family. 
